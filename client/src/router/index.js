...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'docker', name: 'Docker', component: () => import('../views/docker/DockerManage.vue'), meta: { title: 'Docker管理' } },
      { path: 'system-manage', name: 'SystemManage', component: () => import('../views/system/SystemManage.vue'), meta: { title: '系统维护' } },
